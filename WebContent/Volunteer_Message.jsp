...
<body>
	<header >
		...
		<a class="oldermsg" href="oldervolunteermsg.jsp">Older</a>
	</header>	
	<div class="content">
		...
		<div class="achieved">
			<form name="contact-form" action="Adminlogin" method="get">
				<input id="myAnchor" class="checkletter" type="checkbox" name="done" value="<%= volunteer_msg.GetSubmitted_Date() %>">	Achieved  <!-- onChange="this.form.submit()"  onclick="if(this.checked){this.form.submit()}" --> 
				<input type="submit" value="Move to Achieve">
			</form>
			<script>
